    ...
    <div class="container">
      <div class="row site-hero-inner justify-content-center align-items-center">
        <div class="col-md-10 text-center" data-aos="fade">
          <h1 class="heading mb-3">Phòng</h1>
      ...
      <div class="site-block-half d-block d-lg-flex bg-white" data-aos="fade" data-aos-delay="100">
        ...
        <div class="text">
          <span class="d-block mb-4"><span class="display-4 text-primary">$199</span> <span
              class="text-uppercase letter-spacing-2">/ Đêm</span></span>
          <h2 class="mb-4">Phòng ở Hà Nội</h2>
          <p>Ở một nơi xa xôi, phía sau những dãy núi chữ, xa xôi từ các quốc gia Vokalia và Consonantia, sống những
            ...
            ngữ lớn.</p>
          <p><a href="#" class="btn btn-primary text-white">Đặt Ngay</a></p>
        </div>
      </div>
