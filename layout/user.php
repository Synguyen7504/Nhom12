            ...
            <div class="card">
                ...
                <div class="col-md-12" style="margin-top: -70px; " data-aos="fade">
                    <div class="card card-user" style="border: 0px solid white; background-color: rgba(153, 205, 50, 0);">
                        ...
                        <div class="content">
                            <p class="description text-center"> thank you dcm
                                ok im fire
                    ...
                    <form>
                        <div class="row" data-aos="fade">
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" disabled placeholder="Company" value="sy0suy">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Mật khẩu</label>
                                    <input type="password" class="form-control" disabled placeholder="Username" value="michael23">
                        ...
                        <div class="row" data-aos="fade">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Họ</label>
                                    <input type="text" class="form-control" placeholder="Company" value="Trần">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                        ...
                        <div class="row" data-aos="fade">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Email</label>
                                    <input type="text" class="form-control" placeholder="City" value="Synvph39385@123">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Số điện thoại</label>
                                    <input type="text" class="form-control" placeholder="Country" value="0971052629">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
